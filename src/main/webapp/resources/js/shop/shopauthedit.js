$(function() {
	...
	// 根据主键获取授权信息的URL
	var infoUrl = '/bytetubeapp/shopadmin/getshopauthmapbyid?shopAuthId=' + shopAuthId;
	// 修改授权信息的URL
	var shopAuthPostUrl = '/bytetubeapp/shopadmin/modifyshopauthmap';

	if (shopAuthId) {
		getInfo(shopAuthId);
	} else {
		$.toast('user not exist！');
		window.location.href = '/bytetubeapp/shopadmin/shopmanage';
	}

$(function() {
	...
	// 通过awardId获取奖品信息的URL
	var infoUrl = '/bytetubeapp/shopadmin/getawardbyid?awardId=' + awardId;
	// 更新奖品信息的URL
	var awardPostUrl = '/bytetubeapp/shopadmin/modifyaward';
	// 由于奖品添加和编辑使用的是同一个页面，
	// 该标识符用来标明本次是添加还是编辑操作
	var isEdit = false;
	if (awardId) {
		...
		awardPostUrl = '/bytetubeapp/shopadmin/addaward';
	}
	// 获取需要编辑的奖品信息，并赋值给表单
	function getInfo(id) {

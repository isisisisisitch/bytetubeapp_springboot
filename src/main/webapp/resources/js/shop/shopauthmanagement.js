$(function() {
	// 列出该店铺下所有授权信息的URL
	var listUrl = '/bytetubeapp/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=9999';
	// 修改授权信息的URL
	var modifyUrl = '/bytetubeapp/shopadmin/modifyshopauthmap';
	getList();
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							window.location.href = '/bytetubeapp/shopadmin/shopauthedit?shopAuthId='

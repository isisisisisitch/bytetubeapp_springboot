//http://localhost:8080/bytetubeapp/frontend/shoplist
$(function() {
	var loading = false;//如果正在加载，不重复加载
	// 分页允许返回的最大条数，超过此数则禁止访问后台
	var maxItems = 999;
	// 一页返回的最大条数
	var pageSize = 3;
	// 获取店铺列表的URL
	var listUrl = '/bytetubeapp/frontend/listshops';
	// 获取店铺类别列表以及区域列表的URL
	var searchDivUrl = '/bytetubeapp/frontend/listshopspageinfo';
	// 页码
	var pageNum = 1;
	...
	$('.shop-list').on('click', '.card', function(e) {
		...
		window.location.href = '/bytetubeapp/frontend/shopdetail?shopId=' + shopId;
	});

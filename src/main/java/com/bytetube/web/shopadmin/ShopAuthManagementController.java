...
import com.bytetube.dto.ShopAuthMapExecution;
...
import com.bytetube.enums.ShopAuthMapStateEnum;
import com.bytetube.service.PersonInfoService;
import com.bytetube.service.ShopAuthMapService;
...
public class ShopAuthManagementController {
	...
	private String addShopAuthMap(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (auth != null) {
			...
			try {
				// 将解码后的内容用aaa去替换掉之前生成二维码的时候加入的aaa前缀，获取到shopId和createTime转换成WechatInfo实体类

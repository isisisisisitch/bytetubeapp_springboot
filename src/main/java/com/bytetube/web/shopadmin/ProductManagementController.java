...
public class ProductManagementController {
	 ...
	 * @return
	 */
	//http://localhost:8080/bytetube/shopadmin/shopmanagement?shopId=1
	//http://localhost:8080/bytetube/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999
	//
	 ...
	 * @return
	 */
//	http://localhost:8080/bytetube/shopadmin/getproductbyid?productId=1

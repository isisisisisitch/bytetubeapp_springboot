...
import com.bytetube.dto.AwardExecution;
import com.bytetube.entity.Award;
import com.bytetube.entity.Shop;
import com.bytetube.enums.AwardStateEnum;
import com.bytetube.service.AwardService;
	...
	private Map<String, Object> addAward(HttpServletRequest request) {
		...
		if (award != null) {
			try {
				...
				// 添加award
				AwardExecution ae = awardService.addAward(award);
	...
	private Map<String, Object> modifyAward(HttpServletRequest request) {
		...
		if (award != null) {
			try {
				...
				Shop currentShop = (Shop) request.getSession().getAttribute("currentShop");
				award.setShopId(currentShop.getShopId());
				AwardExecution pe = awardService.modifyAward(award);
